            ...
            <div class="w-auto">
              <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 h-auto shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                ...
                <div
                  ...
                  aria-hidden="true"
                >
                  <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-blue-900 to-slate-900 opacity-10"></div>
                </div>
                <figure class="relative isolate">
                  ...
                  <blockquote class="mt-48 text-xl font-semibold leading-8 text-white">
                    <p>
                      "Teknologi monitoring laut memberi kita mata dan telinga
                      untuk memahami cerita yang disampaikan oleh gelombang dan
                      arus."
                    </p>
                  </blockquote>
            ...
            <div className="p-10  h-auto">
              <div class="text-base text-gray-700 w-auto lg:max-w-full">
                ...
                <h1 class="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                  Sistem Monitoring Air Laut (Tide Gauge) dengan Multisensor
                </h1>
                <div class="max-w-xl">
                  <p class="mt-6">
                  ...
                  <p class="mt-6">
                    ...
                    algoritma analitik canggih, sistem dapat mengirimkan
                    peringatan dini saat akan terjadi bencana.
                  </p>
                </div>
              </div>
              <dl class="mt-4 grid grid-cols-2 gap-10 border-t border-gray-900/10 pt-4 sm:grid-cols-4">
                <div>
